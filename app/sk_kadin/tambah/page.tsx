  ...
  return (
    <div className="min-h-screen bg-[#f0f7ff] p-4 md:p-8 text-black font-bold">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-10 border-b-4 border-blue-600 pb-8">
          <div className="flex items-center gap-6">
              ...
              <div>
                 ...
                 <p className="text-black font-black tracking-[0.3em] text-xs mt-2 uppercase">Input Data Arsip Digital</p>
              </div>
          </div>
        ...
        {/* FORM - Trigger Modal saat Submit */}
        <form onSubmit={triggerConfirmModal} className="bg-white rounded-[3rem] shadow-[0_40px_100px_rgba(29,78,216,0.1)] p-10 md:p-16 border-8 border-white space-y-8">
          ...
          <div>
            <label className="block text-sm font-black uppercase tracking-widest mb-3 text-blue-600">TENTANG / PERIHAL SK</label>
            <textarea 
              required
              placeholder="JELASKAN TENTANG SK INI"
              rows={4}
          ...
          <div className="bg-slate-900 p-8 rounded-[2rem] shadow-2xl">
            ...
            />
            <p className="text-[10px] text-blue-300 text-center mt-4 uppercase tracking-[0.2em]">
              Kosongkan jika dokumen fisik belum di-scan atau belum di-upload ke Drive
            </p>
          </div>
        ...
        <p className="text-center mt-10 text-black font-black uppercase tracking-[0.4em] text-[10px]">
          SISTEM MANAJEMEN ARSIP SK KADIN — 2026
        </p>
      </div>
        ...
        <div className="fixed inset-0 z-[999] flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-[3rem] p-10 shadow-2xl relative z-10 w-full max-w-lg border-8 border-white animate-in zoom-in duration-300">
            <div className="text-center">
              <div className="w-24 h-24 bg-blue-100 text-blue-600 rounded-full flex items-center justify-center mx-auto mb-6 text-4xl font-black flex items-center justify-center">?</div>
              ...
              <p className="text-slate-500 font-bold mb-10 uppercase text-sm tracking-widest leading-relaxed text-center">
                Pastikan data SK Kepala Dinas sudah sesuai sebelum disimpan ke dalam database sistem.
              </p>
      ...
      {isSuccessModalOpen && (
        <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
          ...
          <div className="bg-white rounded-[3rem] p-10 shadow-2xl relative z-10 w-full max-w-xl border-8 border-white animate-in zoom-in duration-300 text-center">
            ...
            <h2 className="text-4xl font-black mb-2 uppercase tracking-tighter text-black">ARSIP TERSIMPAN!</h2>
            <p className="text-slate-500 font-bold mb-10 uppercase text-xs tracking-[0.2em] leading-relaxed text-center">
              Data SK Kadin telah berhasil diamankan. Apa tindakan Anda selanjutnya?
            </p>
